...
const Contact = () => {
  return (
    <div className="border-b border-neutral-900 pb-20">
      ...
      <footer className="flex flex-col items-center text-center text-surface dark:text-white">
        <div className="container px-6 pt-6">
          ...
          <div className="w-full bg-primary-100 p-4 text-center text-xs font-medium dark:text-neutral-200 lg:text-left">
            <motion.div
              whileInView={{ opacity: 1, y: 0 }}
              initial={{ opacity: 0, y: -100 }}
              transition={{ duration: 1 }}
